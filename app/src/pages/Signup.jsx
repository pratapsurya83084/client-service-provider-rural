...
const Signup = () => {
  ...
  const inputStyle = (field) => ({
    ...
    boxShadow: focused === field ? "0 0 0 4px rgba(59,130,246,0.10)" : "none"
  });
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        background: "rgba(100,160,255,0.15)", filter: "blur(40px)", pointerEvents: "none"
      }} />
      <div style={{
        position: "fixed", bottom: "-60px", left: "-60px",
        width: "250px", height: "250px", borderRadius: "50%",
        background: "rgba(80,140,255,0.12)", filter: "blur(40px)", pointerEvents: "none"
      }} />
      ...
      <div className="w-full max-w-sm mx-4">
        ...
        <div style={{
              ...
              {roles.map((r) => (
                <button
                  ...
                  style={{
                    ...
                    boxShadow: form.Role === r ? "0 4px 14px rgba(37,99,235,0.25)" : "none"
                  }}
                >
                  {r === "Farmer" && "🌾"}
                  {r === "Customer" && "🧑"}
          ...
          <button
            ...
            onMouseEnter={e => {
              ...
              e.currentTarget.style.boxShadow = "0 6px 22px rgba(37,99,235,0.38)";
            }}
            onMouseLeave={e => {
              e.currentTarget.style.transform = "translateY(0)";
              e.currentTarget.style.boxShadow = "0 4px 18px rgba(37,99,235,0.30)";
            }}
          >
            Create Account
          </button>
        ...
        <div style={{ textAlign: "center", marginTop: "18px" }}>
          ...
          <Link to="/login" style={{
            color: "#3b82f6", fontSize: "0.88rem", fontWeight: "600",
            textDecoration: "none"
          }}>
            Sign In
          </Link>
